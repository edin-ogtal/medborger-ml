...
def train(args):
    ...
    model = BertClassifier(args.model_checkpoint,args.num_labels)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-checkpoint", type=str, default='DJSammy/bert-base-danish-uncased_BotXO,ai', help="name of pretrained model from huggingface model hub")
